...
export function TestimonialsSection() {
  const testimonials = [
    ...
    {
      quote: "Creators feel isolated and want a space to connect, collaborate, and learn from other African creators.",
            ...
            >
              <Card className="p-6 shadow-lg bg-white dark:bg-gray-800 flex flex-col items-center text-center transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-xl">
                ...
                <CardContent className="p-0">
                  <p className="text-lg italic text-gray-800 dark:text-gray-200 mb-4">{testimonial.quote}</p>
